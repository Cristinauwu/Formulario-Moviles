package com.cristina.formularios
...
class MainActivity : AppCompatActivity() {
    ...
    private val fabClick = View.OnClickListener { fab ->
       val alertDialog = AlertDialog.Builder(fab.context)
            ...
            .setMessage("Este es un mensaje de ejemplo de Alert Dialog")
            .setPositiveButton("Ok"
            ) { dialog, p1 -> Toast.makeText(fab.context, "Click en ok", Toast.LENGTH_LONG).show() }
